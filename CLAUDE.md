...
Source of truth for game rules: `docs/CREDD_Master_Export_v4.2.md` (§35 authoritative) +
`docs/CREDD_Technical_Blueprint_v4.md` + `scripts/credd_schema_v4.sql`.
...
- Item icons come from custom emojis via `src/utils/emojis.js`, which parses the registry
  `assets/data/game_items.txt` (Display Name | 'emoji_name' | 'emoji_id'). Use
