...
const CATEGORIES = [
  ...
  },
  {
    ...
    lines: [
      ...
      { canonical: 'deity', cmd: 'crd deity ascend [name] (deh)', desc: 'Ascend a deity' },
      { canonical: 'glossary', cmd: 'crd glossary', desc: 'Codex: deities, weapons, armors, runes' },
    ],
  },
  {
  ...
  },
  {
    ...
    lines: [
      ...
      { canonical: 'preset', cmd: 'crd preset / crd equip preset <1|2>', desc: 'View or switch character presets', prefixOnly: true },
