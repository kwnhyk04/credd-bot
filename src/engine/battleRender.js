...
const {
  logEmbeds, battleLogNavigationRow, showPaginatedBattleLog,
  causeOfDeathText, isDiscordErrorCode, pagerMemoryStats, BATTLE_LOG_COLLECTOR_MS,
} = require('./battleLogPager');
...
registerMemorySource('battle.runtime', () => ({
  ...
  activeLogPageCollectors: pagerMemoryStats().activeLogPageCollectors,
}));
