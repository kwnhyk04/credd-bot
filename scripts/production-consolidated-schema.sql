...
CREATE TABLE IF NOT EXISTS public."boss_spawn_queue" (
    "queue_id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "guild_id" character varying(20) NOT NULL,
    ...
    CONSTRAINT boss_spawn_queue_status_check
...
CREATE UNIQUE INDEX IF NOT EXISTS boss_spawn_queue_one_live_per_guild
    ...
    WHERE ("status" IN ('pending'::character varying, 'spawning'::character varying));
...
CREATE TABLE IF NOT EXISTS public."supporter_item_grants" (
    ...
    CONSTRAINT "supporter_item_grants_item_key_check" CHECK ("item_key" = 'custom_deity_token'),
...
CREATE TABLE IF NOT EXISTS public."tickets" (
    ...
    CONSTRAINT "tickets_type_check" CHECK ("type" IN ('avatar', 'deity')),
    CONSTRAINT "tickets_status_check" CHECK ("status" IN ('queued', 'in_progress', 'done'))
);
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_presets_discord_id_fkey' AND conrelid = 'public.user_presets'::regclass) THEN
    ALTER TABLE public."user_presets" ADD CONSTRAINT "user_presets_discord_id_fkey" FOREIGN KEY (discord_id) REFERENCES users(discord_id) ON DELETE CASCADE;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_presets_equipped_armor_id_fkey' AND conrelid = 'public.user_presets'::regclass) THEN
    ALTER TABLE public."user_presets" ADD CONSTRAINT "user_presets_equipped_armor_id_fkey" FOREIGN KEY (equipped_armor_id) REFERENCES user_armors(armor_id) ON DELETE SET NULL;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_presets_equipped_deity_1_id_fkey' AND conrelid = 'public.user_presets'::regclass) THEN
    ALTER TABLE public."user_presets" ADD CONSTRAINT "user_presets_equipped_deity_1_id_fkey" FOREIGN KEY (equipped_deity_1_id) REFERENCES user_deities(user_deity_id) ON DELETE SET NULL;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_presets_equipped_deity_2_id_fkey' AND conrelid = 'public.user_presets'::regclass) THEN
    ALTER TABLE public."user_presets" ADD CONSTRAINT "user_presets_equipped_deity_2_id_fkey" FOREIGN KEY (equipped_deity_2_id) REFERENCES user_deities(user_deity_id) ON DELETE SET NULL;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_presets_equipped_deity_3_id_fkey' AND conrelid = 'public.user_presets'::regclass) THEN
    ALTER TABLE public."user_presets" ADD CONSTRAINT "user_presets_equipped_deity_3_id_fkey" FOREIGN KEY (equipped_deity_3_id) REFERENCES user_deities(user_deity_id) ON DELETE SET NULL;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_presets_equipped_echo_deity_id_fkey' AND conrelid = 'public.user_presets'::regclass) THEN
    ALTER TABLE public."user_presets" ADD CONSTRAINT "user_presets_equipped_echo_deity_id_fkey" FOREIGN KEY (equipped_echo_deity_id) REFERENCES user_deities(user_deity_id) ON DELETE SET NULL;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'user_presets_equipped_weapon_id_fkey' AND conrelid = 'public.user_presets'::regclass) THEN
    ALTER TABLE public."user_presets" ADD CONSTRAINT "user_presets_equipped_weapon_id_fkey" FOREIGN KEY (equipped_weapon_id) REFERENCES user_weapons(weapon_id) ON DELETE SET NULL;
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint
     WHERE conname = 'supporter_item_grants_discord_id_fkey'
       AND conrelid = 'public.supporter_item_grants'::regclass
  ) THEN
    ALTER TABLE public."supporter_item_grants"
      ADD CONSTRAINT "supporter_item_grants_discord_id_fkey"
...
CREATE INDEX IF NOT EXISTS idx_tickets_status_type_created ON public.tickets USING btree (status, type, created_at);
...
CREATE INDEX IF NOT EXISTS idx_user_presets_discord_id ON public.user_presets USING btree (discord_id);
