...
const DEITY_UPDATES = Object.freeze([
  ...
  { name: 'Apolaki', key: 'apolaki_solar_burn', description: "Each attack applies Burn to the enemy equal to 10% of the user's base ATK. The Burn deals its damage at the end of the enemy's next turn, then expires. Each hit refreshes it." },
