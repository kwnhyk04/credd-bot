...
const DEITY_UPDATES = Object.freeze([
  ...
  { name: 'Sidapa', key: 'sidapa_deaths_reprieve', description: 'Once per battle, the first lethal hit leaves Sidapa at 1 HP. He then heals 30% max HP and gains +50% ATK for the rest of the battle.' },
  { name: 'Apolaki', key: 'apolaki_solar_burn', description: "Each of Apolaki's attacks applies Burn to the enemy equal to 10% of Apolaki's ATK. The Burn deals its damage at the end of the enemy's next turn, then expires. Each hit refreshes it." },
  ...
  { name: 'Skadi', key: 'skadi_winters_hunt', description: "Each turn, Skadi's attack has a 30% chance to Freeze the enemy (skips its next turn). After the Freeze ends, the enemy suffers Frostbite, taking +50% damage from all sources for 1 turn." },
  ...
  { name: 'Thor', key: 'thor_mjolnirs_wrath', description: "Each attack has a 30% chance to Stun the enemy (skips its next turn) and applies Paralyze for 3 turns. While paralyzed, the enemy takes paralysis damage equal to 20% of Thor's ATK each turn and has a 10% chance per turn to skip that turn." },
  { name: 'Tyr', key: 'tyr_oathkeeper', description: 'DEF +30% for the whole battle; while below 50% HP, reflects 20% of incoming damage.' },
  { name: 'Baldur', key: 'baldur_invulnerability', description: 'Once per battle, the first time Baldur is debuffed or drops below 50% HP, remove all debuffs, restore 15% max HP, and reduce damage taken by 50% for 1 turn.' },
