...
const DEITY_UPDATES = Object.freeze([
  ...
  { name: 'Apolaki', key: 'apolaki_solar_burn', description: "Every attack applies Burn equal to 10% of the user's base ATK for 1 turn." },
  ...
  { name: 'Skadi', key: 'skadi_winters_hunt', description: "Each attack has a 30% chance to Freeze the enemy (skips its next turn). After the Freeze ends, the enemy suffers Frostbite, taking more +50% damage for 1 turn." },
  { name: 'Surt', key: 'surt_muspells_flame', description: "Every landed hit adds Burn equal to 5% of the user's base ATK per turn for 2 turns, stacking up to 30%. Against an already-burning enemy, attacks deal +50% bonus damage." },
  { name: 'Thor', key: 'thor_mjolnirs_wrath', description: "Each attack has a 30% chance to Stun the enemy and applies Paralyze for 3 turns. Enemy takes paralysis damage equal to 20% of the user's base ATK each turn and has a 10% chance per turn to skip that turn." },
