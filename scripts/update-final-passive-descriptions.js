...
const DEITY_UPDATES = Object.freeze([
  ...
  { name: 'Apolaki', key: 'apolaki_solar_burn', description: "Every landed hit applies Burn equal to 10% of the user's base ATK. The Burn deals 1 tick, then expires; later landed hits refresh it." },
